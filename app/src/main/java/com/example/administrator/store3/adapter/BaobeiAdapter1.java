 ...
 * 全部宝贝列表的适配器
 */
public class BaobeiAdapter1 extends BaseAdapter {
    /*页面上下文*/
    ...
    /*适配器构造方法,用来传值*/
    public BaobeiAdapter1(Context context,int[]image,List<Boolean>list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            /*item布局初始化*/
            convertView=View.inflate(context, R.layout.quanbubaobei_item,null);
            /*控件初始化*/
            ...
            viewHolder.youfei= (TextView) convertView.findViewById(R.id.baoyou);
            viewHolder.diqu= (TextView) convertView.findViewById(R.id.diqu);
