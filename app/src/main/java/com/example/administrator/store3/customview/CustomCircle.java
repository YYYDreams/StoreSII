...
public class CustomCircle extends ImageView {
    ...
    public CustomCircle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
 ...
 private void setCustomAttributes(AttributeSet attrs) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap roundBitmap = getCroppedRoundBitmap(bitmap, radius-5);
        canvas.drawBitmap(roundBitmap, defaultWidth / 2 - radius+5, defaultHeight
                / 2 - radius+5, null);
    }
