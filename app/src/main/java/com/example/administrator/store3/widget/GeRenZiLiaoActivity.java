package com.example.administrator.store3.widget;
...
public class GeRenZiLiaoActivity extends Activity implements View.OnClickListener{
    ...
    private LinearLayout mLinearLayout0,mLinearLayout1,mLinearLayout2,mLinearLayout3;
    private LinearLayout mLinearLayout4,mLinearLayout5,mLinearLayout6,mLinearLayout7;
   ...
   /*     mLinearLayout0= (LinearLayout) findViewById(R.id.line_portrait);
        mLinearLayout1= (LinearLayout) findViewById(R.id.line_username);
        mLinearLayout2= (LinearLayout) findViewById(R.id.line_nickname);
        mLinearLayout3= (LinearLayout) findViewById(R.id.line_gender);
        mLinearLayout4= (LinearLayout) findViewById(R.id.line_date);
        mLinearLayout5= (LinearLayout) findViewById(R.id.line_signature);*/
        //mLinearLayout6= (LinearLayout) findViewById(R.id.line_password);
       // mLinearLayout7= (LinearLayout) findViewById(R.id.line_sex);
