 ...
 * 自定义画横线
 */
public class CustomLine extends ImageView {
    Paint paint; //画笔,包含了画几何图形、文本等的样式和颜色信息
    ...
    public CustomLine(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        int lineColor = a.getColor(R.styleable. dashedline_lineColor, 0XFFB4B4B4);
        a.recycle();
    ...
    public CustomLine(Context context, AttributeSet attrs, int defStyleAttr, Paint mPaint) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomLine(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
